...
export class AdminCustomersService extends BaseService {
  ...
  create(
    payload: CreateAdminCustomerRequestDto,
  ): Observable<AdminManagedUserDto> {
  ...
  getSummary(): Observable<AdminCustomerSummaryDto> {
    return this.httpClient.get<AdminCustomerSummaryDto>(
      `${this.baseUrl}/admin/customers/summary`,
    );
  }
